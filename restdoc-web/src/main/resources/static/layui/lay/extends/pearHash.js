layui.define(function(exports) {
	...
	/**
	 * Convert a raw string to a restdoc.web.base-64 string
	 */
	...
	pearHash = {
		...
		MD5: function(options) {
			...
			var hexcase = (options && typeof options.uppercase === 'boolean') ? options.uppercase : false, // hexadecimal output case format. false - lowercase; true - uppercase
				b64pad = (options && typeof options.pad === 'string') ? options.pad : '=', // restdoc.web.base-64 pad character. Defaults to '=' for strict RFC compliance
		...
		SHA256: function(options) {
			...
			var hexcase = (options && typeof options.uppercase === 'boolean') ? options.uppercase : false, // hexadecimal output case format. false - lowercase; true - uppercase  */
				...
				/* restdoc.web.base-64 pad character. Default '=' for strict RFC compliance   */

 ...
 */
package smartdoc.dashboard.base.mongo;
...
public class EntityOperations {
    ...
    public EntityOperations(MappingContext<? extends MongoPersistentEntity<?>, MongoPersistentProperty> context) {
    ...
    private static class UnmappedEntity<T extends Map<String, Object>> implements AdaptibleEntity<T> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getIdPropertyName()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getId()
         */
        @Override
        public Object getId() {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getByIdQuery()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.MutablePersistableSource#populateIdIfNecessary(java.lang.Object)
         */
        @Nullable
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getQueryForVersion()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#toMappedDocument(org.springframework.data.mongodb.restdoc.web.core.convert.MongoWriter)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.MutablePersistableSource#initializeVersionProperty()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.MutablePersistableSource#getVersion()
         */
        @Override
        @Nullable
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.MutablePersistableSource#incrementVersion()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getBean()
         */
        @Override
        public T getBean() {
            return map;
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.Entity#isNew()
         */
        @Override
    ...
    private static class MappedEntity<T> implements Entity<T> {
        ...
        public MappedEntity(MongoPersistentEntity<?> entity, IdentifierAccessor idAccessor, PersistentPropertyAccessor<T> propertyAccessor) {
            this.entity = entity;
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getQueryForVersion(java.lang.Object)
         */
        @Override
        public Query getQueryForVersion() {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.Entity#assertUpdateableIdIfNotSet()
         */
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#isVersionedEntity()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.PersistableSource#getVersion()
         */
        @Override
        @Nullable
    ...
    private static class AdaptibleMappedEntity<T> extends MappedEntity<T> implements AdaptibleEntity<T> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.AdaptibleEntity#populateIdIfNecessary(java.lang.Object)
         */
        @Nullable
        @Override
        public T populateIdIfNecessary(@Nullable Object id) {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.MappedEntity#getVersion()
         */
        @Override
        @Nullable
        public Number getVersion() {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.AdaptibleEntity#initializeVersionProperty()
         */
        @Override
        public T initializeVersionProperty() {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.AdaptibleEntity#incrementVersion()
         */
        @Override
        public T incrementVersion() {
    ...
    enum UntypedOperations implements TypedOperations<Object> {
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.TypedOperations#getCollation()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.springframework.data.mongodb.restdoc.web.core.EntityOperations.TypedOperations#getCollation(org.springframework.data.mongodb.restdoc.web.core.query.Query)
         */
        @Override
    ...
    static class TypedEntityOperations<T> implements TypedOperations<T> {
        ...
        public TypedEntityOperations(MongoPersistentEntity<T> entity) {
            this.entity = entity;
        }
